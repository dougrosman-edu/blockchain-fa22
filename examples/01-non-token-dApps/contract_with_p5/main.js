...
// the contractWithSigner variable needs to be declared outside main() so that it's a global variable.
...
function draw() {
  ...
  if(x > 180 && shouldMint) {
    ...
    // because contractWithSigner is global, we can access it here, outside of main()
    contractWithSigner.increaseNum();
    shouldMint = false;
  }
}